...
<body>
   ...
   <div class="body1">
      <div class="writerBox">
         <form id="payMent"
            action="<%=request.getContextPath()%>/allianPay.vo" method="post">
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
               <tr
                  style="background: url('img/table_mid.gif') repeat-x; text-align: center;">
                  <td width="5"><img src="img/table_left.gif" width="5"
                     height="30" /></td>
                  <td class="mainName">결제 이용 약관</td>
            ...
            <table>
               ...
               <tr>
               <tr>
                  <%-- <td>&nbsp;<input type="hidden" name="serviceNo" value=<%=serviceNo %>> </td>  --%>
                  <td><textarea name="textarea" cols="93" rows="30">
                  전자금융거래 기본약관
...
이 약관은 2012년 7월 31일부터 적용합니다.
               ...
               <tr>
                  <td><input type="hidden" name="serviceNo"
                     value=<%=serviceNo%>></td>
                  <td><input type="hidden" name="allianCode"
                     value=<%=allianCode%>></td>
                  <td><input type="hidden" name="rwNo" value=<%=rwNo%>></td>
                  <td><input type="hidden" name="allianLink"
                     value=<%=allianLink%>></td>
               </tr>
               <tr>
                  <td><input class="checkBtn" type="checkbox">
                  <p class="pay">결제 동의</p></td>
               </tr>
               <tr align="center">
                  <td>&nbsp;</td>
                  <td colspan="2"><input type=submit value="결제하기" id="payBtn">
                     <input type=button class="backBtn" value="돌아가기" onclick="backNotice()">
                  <td>&nbsp;</td>
               </tr>
            </table>
         </form>
